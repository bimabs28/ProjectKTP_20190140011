...
public class Data implements Serializable {
    ...
    public Data(Long id, String noktp, String nama, Date tglahir, String jeniskelamin, String alamat, String agama, String status, String warganegara) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
    ...
    public String toString() {
        return "com.ktp.project.ktp.Data[ id=" + id + " ]";
    }
